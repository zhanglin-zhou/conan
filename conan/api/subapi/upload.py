...
class UploadAPI:
    ...
    def prepare(self, package_list, enabled_remotes, binary_compression_format, metadata=None):
        ...
        preparator.prepare(package_list, enabled_remotes, binary_compression_format)
